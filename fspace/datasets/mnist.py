...
def get_mnist(root=None, seed=42, val_size=1/6, normalize=None, channels_last=False, **_):
...
def get_fmnist(root=None, seed=42, val_size=1/6, normalize=None, channels_last=False, **_):
...
def get_kmnist(root=None, seed=42, val_size=1/6, normalize=None, channels_last=False, **_):
